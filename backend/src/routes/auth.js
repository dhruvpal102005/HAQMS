...
router.post('/register', async (req, res) => {
  try {
    // SENSITIVE CONSOLE LOG FIXED: Do not log raw request bodies containing cleartext passwords!
...
router.post('/login', async (req, res) => {
  try {
    // SENSITIVE CONSOLE LOG FIXED: Do not log plain-text passwords on login attempts!
